    ...
    public function displayStatistics()
    {
        ...
        $sql = 'select title, date(tt.created_at) as day, floor(avg(time_diff)) as service_avg
                from (
                         ...
                         from (
                                  select client_id, visit.specialist_id, s.title, created_at, extract(epoch from(created_at-lag(created_at) over (partition by client_id order by client_id, created_at))) as time_diff
                                  from visit
